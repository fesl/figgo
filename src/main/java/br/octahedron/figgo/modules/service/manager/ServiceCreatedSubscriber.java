 ...
 *
 */
@InterestedEvent(events = { ServiceCreatedEvent.class })
public class ServiceCreatedSubscriber extends AbstractNamespaceSubscriber {
	...
	protected void processEvent(Event e) {
		ServiceCreatedEvent event = (ServiceCreatedEvent) e;
		this.serviceManager.createServiceCategory(event.getCategoryId(), event.getCategory());
	}
