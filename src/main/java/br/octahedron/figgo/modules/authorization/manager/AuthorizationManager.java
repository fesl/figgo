...
public class AuthorizationManager {
	 ...
	 */
	public RoleView createRole(String domain, String roleName) {
		List<String> emtpyList = Collections.emptyList();
		return this.createRole(domain, roleName, emtpyList);
	}
	...
	public Collection<String> getAcitivities() {
		...
		for (Module module : Module.values()) {
			if (module.getModuleSpec().getModuleType() == Module.Type.DOMAIN) {
				activities.addAll(module.getModuleSpec().getModuleActions());
			}
		}
		return activities;
	}
	 ...
	 * @param activities
	 */
	public Role createRole(String domain, String roleName, List<String> activities) {
